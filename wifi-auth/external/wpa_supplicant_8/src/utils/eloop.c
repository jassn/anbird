...
struct eloop_timeout {
	...
	void *eloop_data;
	void *user_data;
	eloop_timeout_handler handlter;
	WPA_TRACE_REF(eloop);
	WPA_TRACE_REF(user);
	WPA_TRACE_INFO
};
...
#if 1
				//wpa_printf(MSG_WARNING, "js3n ...... Line.1193, handler %p", handler);
				wpa_printf(MSG_WARNING, "js3n ... 1196.b");
#endif
